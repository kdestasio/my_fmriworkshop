...
for dir in subdirs:
  subnum=dir[-3:]
  print(subnum)
#  ntime = os.popen('fslnvols %s/bold.nii.gz'%(dir)).read().rstrip() # Change the numbe of volumes if your runs vary in length (tells you how many volumes there are and saves in a variable)
